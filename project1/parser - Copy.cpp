...
int main(int argc, char* argv[]){
						...
						switch(o){	//FIRST OPERAND STAGE
							...
							case 16:	//SD	
								...
								/*else if(input[i] == '-'||input[i]=='1'||input[i]=='2'||input[i]=='3'||input[i]=='4'||input[i]=='5'||input[i]=='6'||input[i]=='7'||input[i]=='8'||input[i]=='9'||input[i]=='0'){
									...
									cerr << "Error: First operand must be a register on line " << lineCounter << endl;
									i+=100;
								}
								...
								if(o == 1||o == 3||o == 18||o == 19){	//ALU, LD
									if(input[i] == 'R'){					//just counts registers
										...
										cerr << "Error: Must have a register as second operand of line " << lineCounter << endl;
										i+=100;
									}
									...
									i++;
										...
										cerr << "Error: Third operand of this line must be a register" << endl;
										i += 100;
									}
									/*}	
									else{										
								...
								if(o == 0||o == 2||o == 4||o == 5){		//INTEGER ALUs
									if(input[i] == '-'||input[i]=='1'||input[i]=='2'||input[i]=='3'||input[i]=='4'||input[i]=='5'||input[i]=='6'||input[i]=='7'||input[i]=='8'||input[i]=='9'||input[i]=='0'){
										...
										cerr << "Error: Second operand must be a integer on line " << lineCounter << endl;
										i+=100;
									}
									...
									if(input[i] == 'R'){					//just counts registers
										...
										cerr << "Error: Third operand must be a register on line " << lineCounter << endl;
										i+=100;
									}
							...
							case 14:	//LD	-//can have registers OR integers following them
								if(input[i] == 'R'){					//just counts registers
									...
									cerr << "First operand error on line " << lineCounter << endl;
									i+=100;
								}
								...
								if(input[i] == 'R'){					//just counts registers
									...
									cerr << "Error: Second operand must be a register on line " << lineCounter << endl;
									i+=100;
								}
							...
							case 15:	//-//LDi and SDi must have integer following them
								if(input[i] == '-'||input[i]=='1'||input[i]=='2'||input[i]=='3'||input[i]=='4'||input[i]=='5'||input[i]=='6'||input[i]=='7'||input[i]=='8'||input[i]=='9'||input[i]=='0'){
									...
									cerr << "Error: Invalid format on line " << lineCounter << endl;
									i += 100;
								}
								...
								if(o == 13){ //LDi - SECOND OPERAND
									...
									if(input[i] == 'R'){					//just counts registers
										...
										if(input[i] != ' ' && input[i] != '\t' && input[i] != '\n' && input[i] != '\0' && input[i] != '#'){
											cerr << "Error: wrong SDi format on line " << lineCounter << endl;
											i+=100;
										}
										operands++;
									}
	...
	cout << opcodeCounter << " opcodes" << endl;
